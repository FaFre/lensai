...
class ProxyProfile extends Table
  ...
  late final GeneratedColumn<int> autostart = GeneratedColumn<int>(
    'autostart',
    aliasedName,
    false,
...
class ProxyProfileData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['autostart'] = Variable<int>(autostart);
  ...
  factory ProxyProfileData.fromJson(
    ...
    return ProxyProfileData(
      ...
      autostart: serializer.fromJson<int>(json['autostart']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'autostart': serializer.toJson<int>(autostart),
