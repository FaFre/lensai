...
class ProxyProfileData extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, type, configJson, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class ProxyRoutingSetting extends Table
    with TableInfo<ProxyRoutingSetting, ProxyRoutingSettingData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ProxyRoutingSetting(this.attachedDatabase, [this._alias]);
  ...
  late final GeneratedColumn<String> regularTabsMode = GeneratedColumn<String>(
    'regular_tabs_mode',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> regularTabsProxyConnectionId =
  ...
  late final GeneratedColumn<String> privateTabsProxyConnectionId =
      GeneratedColumn<String>(
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'proxy_routing_setting';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ProxyRoutingSettingData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ProxyRoutingSettingData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
      regularTabsMode: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}regular_tabs_mode'],
      )!,
      regularTabsProxyConnectionId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}regular_tabs_proxy_connection_id'],
      ),
      privateTabsProxyConnectionId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}private_tabs_proxy_connection_id'],
      ),
    );
  }

  @override
  ProxyRoutingSetting createAlias(String alias) {
    return ProxyRoutingSetting(attachedDatabase, alias);
  }
...
class ProxyRoutingSettingData extends DataClass
    implements Insertable<ProxyRoutingSettingData> {
  final int id;
  final String regularTabsMode;
  final String? regularTabsProxyConnectionId;
  final String? privateTabsProxyConnectionId;
  const ProxyRoutingSettingData({
    required this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['regular_tabs_mode'] = Variable<String>(regularTabsMode);
    if (!nullToAbsent || regularTabsProxyConnectionId != null) {
      map['regular_tabs_proxy_connection_id'] = Variable<String>(
        regularTabsProxyConnectionId,
      );
    }
    if (!nullToAbsent || privateTabsProxyConnectionId != null) {
      map['private_tabs_proxy_connection_id'] = Variable<String>(
        privateTabsProxyConnectionId,
      );
    }
    return map;
  ...
  factory ProxyRoutingSettingData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ProxyRoutingSettingData(
      ...
      regularTabsMode: serializer.fromJson<String>(json['regularTabsMode']),
      regularTabsProxyConnectionId: serializer.fromJson<String?>(
        json['regularTabsProxyConnectionId'],
      ),
      privateTabsProxyConnectionId: serializer.fromJson<String?>(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'regularTabsMode': serializer.toJson<String>(regularTabsMode),
      'regularTabsProxyConnectionId': serializer.toJson<String?>(
        regularTabsProxyConnectionId,
      ),
      'privateTabsProxyConnectionId': serializer.toJson<String?>(
        privateTabsProxyConnectionId,
      ),
    };
  }

  ProxyRoutingSettingData copyWith({
    int? id,
    String? regularTabsMode,
    Value<String?> regularTabsProxyConnectionId = const Value.absent(),
    Value<String?> privateTabsProxyConnectionId = const Value.absent(),
  }) => ProxyRoutingSettingData(
    id: id ?? this.id,
    regularTabsMode: regularTabsMode ?? this.regularTabsMode,
    regularTabsProxyConnectionId: regularTabsProxyConnectionId.present
        ? regularTabsProxyConnectionId.value
        : this.regularTabsProxyConnectionId,
    privateTabsProxyConnectionId: privateTabsProxyConnectionId.present
        ? privateTabsProxyConnectionId.value
        : this.privateTabsProxyConnectionId,
  );
  ProxyRoutingSettingData copyWithCompanion(ProxyRoutingSettingCompanion data) {
    return ProxyRoutingSettingData(
      id: data.id.present ? data.id.value : this.id,
      regularTabsMode: data.regularTabsMode.present
          ? data.regularTabsMode.value
          : this.regularTabsMode,
      regularTabsProxyConnectionId: data.regularTabsProxyConnectionId.present
          ? data.regularTabsProxyConnectionId.value
          : this.regularTabsProxyConnectionId,
      privateTabsProxyConnectionId: data.privateTabsProxyConnectionId.present
          ? data.privateTabsProxyConnectionId.value
          : this.privateTabsProxyConnectionId,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('ProxyRoutingSettingData(')
          ..write('id: $id, ')
          ..write('regularTabsMode: $regularTabsMode, ')
          ..write(
            'regularTabsProxyConnectionId: $regularTabsProxyConnectionId, ',
          )
          ..write('privateTabsProxyConnectionId: $privateTabsProxyConnectionId')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProxyRoutingSettingData &&
          other.id == this.id &&
          other.regularTabsMode == this.regularTabsMode &&
          other.regularTabsProxyConnectionId ==
              this.regularTabsProxyConnectionId &&
          other.privateTabsProxyConnectionId ==
              this.privateTabsProxyConnectionId);
}

class ProxyRoutingSettingCompanion
    extends UpdateCompanion<ProxyRoutingSettingData> {
  final Value<int> id;
  final Value<String> regularTabsMode;
  final Value<String?> regularTabsProxyConnectionId;
  final Value<String?> privateTabsProxyConnectionId;
  const ProxyRoutingSettingCompanion({
    this.id = const Value.absent(),
    this.regularTabsMode = const Value.absent(),
    this.regularTabsProxyConnectionId = const Value.absent(),
    this.privateTabsProxyConnectionId = const Value.absent(),
  });
  ProxyRoutingSettingCompanion.insert({
    this.id = const Value.absent(),
    required String regularTabsMode,
    this.regularTabsProxyConnectionId = const Value.absent(),
    this.privateTabsProxyConnectionId = const Value.absent(),
  }) : regularTabsMode = Value(regularTabsMode);
  static Insertable<ProxyRoutingSettingData> custom({
    Expression<int>? id,
    Expression<String>? regularTabsMode,
    Expression<String>? regularTabsProxyConnectionId,
    Expression<String>? privateTabsProxyConnectionId,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (regularTabsMode != null) 'regular_tabs_mode': regularTabsMode,
      if (regularTabsProxyConnectionId != null)
        'regular_tabs_proxy_connection_id': regularTabsProxyConnectionId,
      if (privateTabsProxyConnectionId != null)
        'private_tabs_proxy_connection_id': privateTabsProxyConnectionId,
    });
  }

  ProxyRoutingSettingCompanion copyWith({
    Value<int>? id,
    Value<String>? regularTabsMode,
    Value<String?>? regularTabsProxyConnectionId,
    Value<String?>? privateTabsProxyConnectionId,
  }) {
    return ProxyRoutingSettingCompanion(
      id: id ?? this.id,
      regularTabsMode: regularTabsMode ?? this.regularTabsMode,
      regularTabsProxyConnectionId:
          regularTabsProxyConnectionId ?? this.regularTabsProxyConnectionId,
      privateTabsProxyConnectionId:
          privateTabsProxyConnectionId ?? this.privateTabsProxyConnectionId,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (regularTabsMode.present) {
      map['regular_tabs_mode'] = Variable<String>(regularTabsMode.value);
    }
    if (regularTabsProxyConnectionId.present) {
      map['regular_tabs_proxy_connection_id'] = Variable<String>(
        regularTabsProxyConnectionId.value,
      );
    }
    if (privateTabsProxyConnectionId.present) {
      map['private_tabs_proxy_connection_id'] = Variable<String>(
        privateTabsProxyConnectionId.value,
      );
    }
  ...
  @override
  String toString() {
    return (StringBuffer('ProxyRoutingSettingCompanion(')
          ..write('id: $id, ')
          ..write('regularTabsMode: $regularTabsMode, ')
          ..write(
            'regularTabsProxyConnectionId: $regularTabsProxyConnectionId, ',
...
class DatabaseAtV6 extends GeneratedDatabase {
  ...
  late final ProxyRoutingSetting proxyRoutingSetting = ProxyRoutingSetting(
    this,
  );
